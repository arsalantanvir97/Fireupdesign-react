      ...
      <div className="container-fluid p-0">
        <div className="row no-gutters">
          <div className="col-lg-8">
            <img src="images/social-media-banner.jpg" className="img-fluid hero-banner" alt="" />
          </div>
          <div className="col-lg-4">
            <div className="hero__wrap">
              ...
              <p className="hero-subline">Build an online community of happy, <br /> loyal customers who love what you do</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="custom-container-wrap pt-0 pb-0">
        <div className="row align-items-center ">
          ...
          <div className="col-12 col-lg-10 col-xl-8 m-auto text-left">
            <h5 className="heading-5 text-center">Why you need Fire Up social media services </h5>
            <ul>
              <li className="mb-3">As of 2021, there were 3.78 billion social media users worldwide – that’s a whole lot of people out there who might just love what you do!</li>
              <li className="mb-3">Over 84% of social media users are aged 18-29, 81% are 30-49, 73% are aged 50 -64 and 45% are aged over 65, and it’s essential to target your socials to the right demographic</li>
              <li className="mb-3">The average person spends 2.5 hours a day on social media</li>
              <li className="mb-3">Over 73% of marketers believe that social media plays an important role in their business operations </li>
              <li className="mb-3">54% of internet browsers use social media to make decisions about which companies they want to connect with </li>
            </ul>
          </div>
      ...
      <div className="container-fluid px-0">
        <div className="row no-gutters mb-2">
          <div className="col-12 position-relative d-block d-md-flex align-items-center">
            <img src="images/socialstep-banner.jpg" className="w-100" alt="" />
                ...
                <div className="col-lg-7 mx-auto">
                  <div className="media project-steps">
                    <div className="media-body">
                      ...
                      <p className="body-text-16 font-weight-normal">Although we’re techies, we’re really interested in people too – which is the key to any successful social media campaign. Our social media services are consistently rated among the very best in the UK, and this is how we do it:</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
              <div className="media project-steps">
                ...
                <div className="media-body">
                  <h5 className="mt-0"><span className="d-lg-block">Setting</span>Targets</h5>
                  <p className="body-text-16 font-weight-normal">It’s all well and good creating blog posts and social media pages, but if you don’t have clear, measurable targets your efforts are likely to fizzle out after a couple of weeks. We’ll keep you on track with smart objectives that are flexible and easy to achieve. </p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
              <div className="media project-steps">
                ...
                <div className="media-body">
                  <h5 className="mt-0"><span className="d-lg-block">Executing the</span>Plan </h5>
                  <p className="body-text-16 font-weight-normal">It’s been said many times that a goal without a plan is just a wish, and that’s particularly true when it comes to social media. We’ll deliver a targeted strategy that’s achievable and measurable every step of the way.</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-6 mb-4 mb-lg-5 d-flex">
              <div className="media project-steps">
                ...
                <div className="media-body">
                  <h5 className="mt-0"><span className="d-lg-block">Monitoring</span>Progress</h5>
                  <p className="body-text-16 font-weight-normal">The social media landscape is always changing, so we’ll keep a close eye on trends to ensure you’re always at the top of the game. We’ll also provide you with daily reports and make tweaks where necessary, presenting you with clear data that shows you how your campaigns are progressing. </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="project-steps-wrap mt-0">
          <div className="row">
            <div className="col-12 col-lg-9 text-lg-left text-center">
              ...
              <h3 className="mt-2 mb-0">Let’s see where the conversation takes us!</h3>
            </div>
